...
export const metadata: Metadata = {
  ...
  description:
    "Prótesis dentales en Viladecans. Fijas sobre implantes, removibles y coronas de zirconio. Recupera funcionalidad y estética dental. Primera visita gratuita.",
  keywords: [
