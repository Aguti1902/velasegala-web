...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: `${SITE_CONFIG.url}/images/Logos/FAVICON.png`, sizes: "32x32", type: "image/png" },
      { url: `${SITE_CONFIG.url}/images/Logos/FAVICON.png`, sizes: "16x16", type: "image/png" },
      { url: `${SITE_CONFIG.url}/images/Logos/FAVICON.png`, sizes: "192x192", type: "image/png" },
      { url: `${SITE_CONFIG.url}/images/Logos/FAVICON.png`, sizes: "512x512", type: "image/png" },
    ],
    apple: [
      { url: `${SITE_CONFIG.url}/images/Logos/FAVICON.png`, sizes: "180x180", type: "image/png" },
    ],
    shortcut: `${SITE_CONFIG.url}/images/Logos/FAVICON.png`,
  },
  description:
